...
import org.wstone.jmx.ManagementException;
import org.wstone.jmx.util.MBeanImpl;

/**
 * @author German Escobar
 * 
 *         An abstract class used a as a base class for
 *         {@link org.wstone.jmx.MBeanFactory} implementations that
 *         create MBeans from AnnotatedTypes.
 */
public abstract class AbstractMBeanFactory implements MBeanFactory {

  /**
   * This method has to be implemented by concrete classes to retrieve the
   * annotated type from which the MBean is going to be created.
   * 
   * @param instance
   *          the object that is going to be exposed.
   ...
   * (non-Javadoc)
   * 
   * @see org.wstone.jmx.MBeanFactory#createMBean(java.lang.Object)
   */
  @Override
  ...
  /**
   * This method is used to create the {@link ExposedMembers} and the
   * {@link javax.management.MBeanInfo} objects using the AnnotatedType to
   * retrieve everything that should be exposed as JMX.
   * 
   * @param <T>
   * @param at
   * @param visitor
